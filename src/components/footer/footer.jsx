...
const footerLinks = {
  ...
  services: [
    ...
    { label: "Cloud Integration", to: "/services" },
  ...
  industries: [
    ...
    { label: "Finance / FinTech", to: "/industries" },
    ...
    <footer className="footer">
      <div className="footer__inner">
        ...
        <div className="footer__brand">
          <Link to="/" className="footer__logo">
            Zahga <span className="footer__logo-dot"><img className="Logo" src={Logo} alt="" /></span>
          </Link>
          <p className="footer__tagline">
            Innovative technology solutions that help businesses transform, scale, and lead in their industries.
          </p>
        ...
        <div className="footer__links-group">
          ...
          <div className="footer__column">
            <h4 className="footer__column-title">Industries</h4>
            <ul className="footer__list">
      ...
      <div className="footer__bottom">
        <p className="footer__copyright">
          &copy; {new Date().getFullYear()} Zahga. All rights reserved.
        </p>
